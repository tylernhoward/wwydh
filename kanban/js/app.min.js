...
a.boards=b.data;a.updateUsers(b.users)})}},{addClass:"btn btn-info",text:"Cancel",onClick:function(a){a.close()}}]})}}]);taskBoardControllers.controller("BoardFormSettingsCtrl",["$scope","BoardService",function(a,b){a.boardFormData={setFocus:!1,boardId:0,isAdd:!0,name:"",lanes:[],laneName:"",categories:[],categoryName:"",users:[],nameError:!1,lanesError:!1,categoriesError:!1,isSaving:!1,updateLanesSorting:function(){var b=this;$(".lanes").sortable({placeholder:"lane-placeholder",stop:function(d,f){b.lanes.length=0;$(f.item).parent().children().each(function(a){b.lanes.push({id:$(this).find(".hidden").text(),name:$(this).find(".item-text").text(),
...
layout:"center",type:"information",modal:!0,buttons:[{addClass:"btn btn-default",text:"Ok",onClick:function(c){c.close();a.isDeleting[b]=!0;d.removeUser(b).success(function(b){a.alerts.showAlerts(b.alerts);a.updateUsers(b.data);a.updateBoardsList(b.boards)})}},{addClass:"btn btn-info",text:"Cancel",onClick:function(a){a.close()}}]})}}]);taskBoardControllers.controller("UserFormSettingsCtrl",["$scope","UserService",function(a,b){a.userFormData={setFocus:!1,userId:0,isAdd:!0,username:"",password:"",email:"",verifyPass:"",defaultBoard:null,isAdmin:!1,passError:!1,usernameError:!1,emailError:!1,isSaving:!1,setUser:function(a){this.reset();this.isAdd=!1;this.userId=a.id;this.username=a.username;this.email=a.email;this.defaultBoard=a.default_board;this.isAdmin="1"==a.is_admin},reset:function(){$(".popover-dismiss").popover();this.setFocus=
