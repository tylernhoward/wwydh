...
<html>
    ...
    <head>
		...
		<body>
	     <div class="imgViewer" style="background-image: url(https://maps.googleapis.com/maps/api/streetview?size=600x300&location=<?php echo $row['building_address']; echo &nbsp; echo $row['city'];?>&key=AIzaSyBHg5BuXXzfu2Wiz4QTiUjCXUTpaUCWUN0)";></div>
