					...
					<a href="propertyInfo.php?id=<?php echo $row["id"] ?>">
						<div class="location">
							<div class="grid-item">
								...
								<div class="location_image" style="background-image: url(https://maps.googleapis.com/maps/api/streetview?size=600x300&location=<?php echo $row['building_address']; echo &nbsp; echo $row['city'];?>&key=AIzaSyBHg5BuXXzfu2Wiz4QTiUjCXUTpaUCWUN0)";></div>
